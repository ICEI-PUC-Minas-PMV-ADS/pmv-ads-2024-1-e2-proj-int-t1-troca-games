...
| **Resultados** | O teste foi bem sucedido. O usuário conseguiu se cadastrar na aplicação e suas informações ficaram salvas no sistema. |
...
| **Resultados** | O teste foi bem sucedido. O usuário conseguiu realizar o login na aplicação com as informações fornecidas no cadastro. |
| **Ação** | Não foi necessária nenhuma ação. |
...
| **Resultados** | Teste 1: Houve falha quando o usuário tentou editar sua conta.<br> Teste 2: O teste foi bem sucedido. O usuário conseguiu editar suas informações e as informações modificadas foram salvas no sistema. |
| **Ação** | Teste 1: Será corrigida na próxima etapa.<br> Teste 2: Não foi necessária nenhuma ação. |
...
| **Resultados** | Teste 1: Houve falha quando o usuário tentou apagar sua conta.<br> Teste 2: O teste foi bem sucedido. O usuário conseguiu apagar sua conta e todas as suas informações foram deletadas do sistema. |
| **Ação** | Teste 1:  Foi encontrado uma falha no "MinhaContaController" onde foi esquecido de colocar "return RedirectToAction("ContaDeletada")", então o sistema não consegue encontrar a página do usuário deletado. Será corrigida na próxima etapa.<br> Teste 2: Não foi necessária nenhuma ação. |
...
| **Resultados** | O teste foi bem sucedido. Na página de Jogos aparece uma lista com todos os jogos cadastrados no sistema pelos usuários. |
| **Ação** | Não foi necessária nenhuma ação. |
...
| **Resultados** | O teste foi bem sucedido. Ao clicar em Detalhes do jogo escolhido, aparecem todas as informações do jogo selecionado. |
| **Ação** | Não foi necessária nenhuma ação. |

https://github.com/ICEI-PUC-Minas-PMV-ADS/pmv-ads-2024-1-e2-proj-int-t1-troca-games/assets/145761508/b4596bb3-31ad-470b-9d26-c9fa61e48cf4

| **Caso de Teste** | CT-07 – Filtro de pesquisa |
|:---:|---|
| **Requisito Associado** | RF-007 - O sistema deve permitir que o usuário busque por jogos. |
| **Resultados** | O teste foi bem sucedido. O filtro de pesquisa funcionou perfeitamente quando o usuário tentou buscar um jogo pelo nome. |
| **Ação** | Não foi necessária nenhuma ação. |

https://github.com/ICEI-PUC-Minas-PMV-ADS/pmv-ads-2024-1-e2-proj-int-t1-troca-games/assets/145761508/1214385e-7737-49c7-8793-afbe040a7b61
...
| **Resultados** | O teste foi bem sucedido. O usuário conseguiu fazer a reserva do jogo com sucesso e o jogo ficou indisponível na página de Jogos. |
| **Ação** | Não foi necessária nenhuma ação. |

https://github.com/ICEI-PUC-Minas-PMV-ADS/pmv-ads-2024-1-e2-proj-int-t1-troca-games/assets/145761508/2bde9774-6a55-420b-9df3-44637b026d04
...
| **Resultados** | O teste foi bem sucedido. O usuário conseguiu cancelar a reserva do jogo com sucesso e o jogo voltou a ficar disponível na página de Jogos. |
| **Ação** | Não foi necessária nenhuma ação. |

https://github.com/ICEI-PUC-Minas-PMV-ADS/pmv-ads-2024-1-e2-proj-int-t1-troca-games/assets/145761508/4475672d-4a02-435d-943e-951821a623ec

| **Caso de Teste** | CT-10 – Cadastrar jogo |
|:---:|---|
| **Requisito Associado** | RF-010 - O sistema deve permitir que usuários cadastrem novos jogos. |
| **Resultados** | O teste foi bem sucedido. O usuário conseguiu fazer o cadastro do jogo com sucesso e o jogo apareceu na página de Meus Jogos e na página de Jogos. |
| **Ação** | Não foi necessária nenhuma ação. |
...
| **Resultados** | O teste foi bem sucedido. O usuário conseguiu editar as informações do jogo e as informações modificadas foram salvas no sistema com sucesso. |
| **Ação** | Não foi necessária nenhuma ação. |
...
| **Resultados** | O teste foi bem sucedido. O usuário conseguiu apagar o jogo e todas as informações do jogo foram deletadas do sistema com sucesso. |
| **Ação** | Não foi necessária nenhuma ação. |
...
| **Resultados** | O teste foi bem sucedido. O usuário conseguiu adicionar o jogo à sua lista de desejos com sucesso e o jogo apareceu na página de Meus Desejos. |
| **Ação** | Não foi necessária nenhuma ação. |
...
| **Resultados** | O teste foi bem sucedido. O usuário conseguiu apagar o jogo da sua lista de desejos com sucesso e o jogo desapareceu da página de Meus Desejos. |
| **Ação** | Não foi necessária nenhuma ação. |
