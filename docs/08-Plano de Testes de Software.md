...
| Passos 	|  1. Acessar a página principal da aplicação<br> 2. Realizar o login na aplicação<br> 3. Acessar a página "Meus itens" na barra de navegação<br> 4. Clicar no ícone de adicionar<br> 5. Preencher os campos obrigatórios<br> 6. Clicar no botão "Adicionar"<br> |
...
| Passos 	|  1. Acessar a página principal da aplicação<br> 2. Realizar o login na aplicação<br> 3. Acessar a página "Meus itens" na barra de navegação<br> 4. Clicar no ícone de editar<br> 5. Preencher os campos obrigatórios<br> 6. Clicar no botão "Editar"<br> |
...
| Passos 	| 1. Acessar a página principal da aplicação<br> 2. Realizar o login na aplicação<br> 3. Clicar no item desejado<br> 4. Clicar no botão "Favoritar"<br> 5. Acessar a página "Meus favoritos" na barra de navegação<br> |
...
| Passos 	| 1. Acessar a página principal da aplicação<br> 2. Escrever o nome do item na barra de pesquisa |
